...
## วิธีคำนวณคะแนนใน Google Sheet

ระบบรวมคำตอบของหมวดเดียวกันเป็นคะแนน R/I/A/S/E/C แล้วเขียนเฉพาะคะแนนทั้ง 6 ค่า, Holland Code และบุคลิกภาพลงคอลัมน์เดิม `HP:HW` โดยไม่เพิ่มคอลัมน์ช่วยในชีต หากคะแนนรวมเท่ากันจะตัดสินจาก อาชีพ → ความสามารถ → กิจกรรม → ประเมินตนเอง และใช้ลำดับ R-I-A-S-E-C เมื่อคะแนนย่อยยังเท่ากันทั้งหมด
